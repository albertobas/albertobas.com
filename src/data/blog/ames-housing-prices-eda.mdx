...
oGImage: { name: ames-housing-prices-eda.png, width: 1200, height: 630 }
---
...
A graphical analysis will be performed first, looking at the predictors one by one, and then at the plots of the predictors as a function of the response. The figures are classified by level of measurement: ratio, interval, ordinal and nominal. I'll be using this [two functions](https://www.github.com/albertobas/ames-housing-prices/blob/main/utils/eda.py 'EDA functions') to plot the graphics.
