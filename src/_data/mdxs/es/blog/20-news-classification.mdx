...
En esta sección se entrenan cuatro modelos, dos redes convolucionales y dos redes recurrentes, usando [estas funciones de validación](https://www.github.com/albertobas/20-news-classification/blob/main/utils/validation.py).
