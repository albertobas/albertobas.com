...
En Hardhat podemos desplegar un contrato en una red `localhost`. Es necesario iniciar un nodo local y desplegar el contrato. En esta aplicación, `npm run node` y `npm run compile-share-deploy` respectivamente.
