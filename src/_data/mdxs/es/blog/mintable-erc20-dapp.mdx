...
El contrato inteligente está escrito en Solidity y cumple con el [estándar EIP-20](https://eips.ethereum.org/EIPS/eip-20 'EIP-20: Token Standard') specifications.
...
Guardo la dirección de la cuenta y ambos contratos en [`ContractContext`](https://www.github.com/albertobas/mintable-erc20-dapp/blob/main/react-app/src/components/context/ContractContext.tsx) que nos los proporcionará en cualquiera de los componentes que son descendientes de `ContractProvider`.
