...
The latter command will ensure our React app has the current contract address, typings and ABI after compiling the solidity file and deploying it in the `localhost` network.
