...
I keep the account address and both contracts in [`ContractContext`](https://www.github.com/albertobas/mintable-erc20-dapp/blob/main/react-app/src/utils/context/ContractContext.tsx) which will provide us with them in any of the components that are descendants to `ContractProvider`.
