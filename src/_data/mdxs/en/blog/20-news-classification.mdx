...
In this section four models are trained, two convolutional networks and two recurrent networks, using [this validation functions](https://www.github.com/albertobas/20-news-classification/blob/main/utils/validation.py).
